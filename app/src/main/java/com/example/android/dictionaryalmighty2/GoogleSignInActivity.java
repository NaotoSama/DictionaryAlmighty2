        ...
        emailSignInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!email.equals("") && !password.equals("")){
                    ...
                    Toast.makeText(getApplicationContext(),getString(R.string.You_have_not_entered_any_username),Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(findViewById(R.id.main_layout), R.string.status_verification_failed, Snackbar.LENGTH_SHORT).show();
                            updateUI(null);
                            findViewById(R.id.google_loggedIn_textView).setVisibility(View.GONE);
                            findViewById(R.id.emailPasswordLoggedIn_textView).setVisibility(View.GONE);
                        }
